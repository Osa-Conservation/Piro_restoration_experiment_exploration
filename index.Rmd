...
To do so, we checked first the survey locations of bats, amphibians and birds
...
pal_amphibians <- colorNumeric(palette = "Reds", domain = Piro2$Amphibians)
pal_bats <- colorNumeric(palette = "Blues", domain = Piro2$Bats, na.color = "#808080")
pal_birds <- colorNumeric(palette = "Greens", domain = Piro2$Birds)
...
map <- leaflet(Piro2) %>%
  ...
  addCircleMarkers(
    ...
    radius = ~rescale(Amphibians, to = c(5, 20)),
    color = "black",
  ...
  addCircleMarkers(
    ...
    radius = ~ifelse(is.na(Bats), 3, rescale(Bats, to = c(5, 20))),
    color = "black",
  ...
  addCircleMarkers(
    ...
    radius = ~rescale(Birds, to = c(5, 20)),
    color = "black",
  ...
  addLegend("bottomright", 
            colors = "#FF8C00", 
            labels = "Selected Plots (Yes)", 
            title = "Selection", 
            opacity = 0.9, 
            group = "Selected Plots (Yes)")
