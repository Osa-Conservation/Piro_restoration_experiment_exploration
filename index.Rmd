...
# Define colors
plasma_colors <- viridis(2, option = "plasma", begin = 0.3, end = 0.7)
...
fig1 <- plot_ly(
  ...
  layout(
    title = "Amphibian Detections Pre-2025",
    xaxis = list(title = "Number of Detections"),
...
fig2 <- plot_ly(
  ...
  layout(
    title = "Amphibian Detections 2025",
    xaxis = list(title = "Number of Detections"),
    yaxis = list(title = "", categoryorder = "total ascending")
  )
...
subplot(fig1, fig2, nrows = 1, shareY = TRUE, titleX = TRUE, widths = c(0.55, 0.45)) %>%
  layout(
    ...
    margin = list(l = 150, t = 80),  # Increase top margin too
    annotations = list(
      list(x = 0.25, y = 1.05, text = "<b>Pre-2025</b>", showarrow = FALSE, 
           xref = "paper", yref = "paper", font = list(size = 14), xanchor = "center"),
      list(x = 0.8, y = 1.05, text = "<b>2025</b>", showarrow = FALSE, 
           xref = "paper", yref = "paper", font = list(size = 14), xanchor = "center")
    )
  )
...
table(iucn_all$IUCN_status)

#Order
iucn_all <- iucn_all[order(iucn_all$class_name, iucn_all$IUCN_status, iucn_all$Endemism),]
